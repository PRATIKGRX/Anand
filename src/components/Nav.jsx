...
const Nav = () => {
  return (
    <nav className="px-10 fixed top-0 right-0 left-0 z-99 bg-[#EEEEEE] text-[#7D0A0A] shadow-2xl ">
      <div className="flex justify-between items-center h-[10vh]">
        ...
        <div className="flex gap-5 text-md ">
          ...
          <div className="">
            <button className="relative px-2 font-bold py-1 border-[1.5px] border-[#7D0A0A] overflow-hidden transition-colors duration-600 hover:text-white group">
              Request
              <span className="absolute inset-0 transition-opacity duration-300 group-hover:opacity-0"></span>
              <span className="absolute top-1/2 left-1/2 w-22 h-15 -translate-x-1/2 -translate-y-1/2 bg-[#7D0A0A] rounded-full scale-0 opacity-0 -z-10 group-hover:scale-100 group-hover:opacity-100 transition-all duration-600 ease-out"></span>
            </button>
          </div>
        </div>
      </div>
