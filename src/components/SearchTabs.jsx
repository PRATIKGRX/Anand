    ...
    const SteelProducts = [
       ...
       const Sheets = [
        ...
        const Paint = [
          ...
          { src: "https://th.bing.com/th/id/OIP.WyeJz7jNQ8aORXX9_DSu0AHaHa?w=174&h=180&c=7&r=0&o=5&pid=1.7", text: "Roller Brush",description:"this is the description of this ", },
        ];
        const Tools = [
          {
  ...
  return (
    <Box sx={{ width: '100%', bgcolor: '#F5F5F5' }}>
      ...
      {value === 0 && <div className="grid grid-cols-3 gap-4 justify-center ">
        ...
        {value === 5 &&  <div className="grid grid-cols-3 gap-4 justify-center ">
                    {Tools.map((element) => (
                      <ImgCard key={element.text} pic={element.src} picName={element.text} description={element.description} />
                    ))}
                  </div>}
